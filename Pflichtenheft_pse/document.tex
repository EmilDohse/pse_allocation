...
\newglossaryentry{Benutzername}{name=Benutzername, plural=Benutzernamen,
	description={Eindeutiger Name, der im System einem \gls{Admin}, \gls{Projektbetreuer} oder \glspl{Studierender}n zugeordnet ist}} %TODO so ok? Insb. Wegen Studenten?
...
\newglossaryentry{Einteilungskonfiguration}{name=Einteilungskonfiguration, plural=Einteilungskonfigurationen,	description={Das System besitzt bei der Berechnung einer \gls{Einteilung} diverse Parameter und Kriterien, nach denen die \gls{Einteilung} erfolgen kann. Eine \gls{Einteilungskonfiguration} meint genau eine Festlegung dieser Parameter und Kriterien auf einen konkreten Wert}}
...
\subsection{Musskriterien}
 \begin{enumerate}[label=\swtLabel{M}]
   ...
   \item \glspl{Studierender} können vor der \gls{Einteilung} \glspl{Lerngruppe} erstellen, ihnen beitreten und diese wieder verlassen
    \item Übersicht über die eigene \gls{Lerngruppe} durch \glspl{Studierender}
...
\begin{enumerate}[label=\swtLabel{W}]
  ...
  \item Stapelverarbeitung zur Berechnungen verschiedener \gls{Einteilung} mit
  ...
  \item Abbrechen der Berechnung der \gls{Einteilung} möglich 
    ...
    \begin{itemize}
        ...
        \item \glspl{Team} möglichst mit \glspl{Studierender} im gleichen Fachsemester 
...
\item Warnung an den \gls{Admin}, falls er bei der manuellen Nachjustierung 
    ...
    geschickt wird
    \item Benachrichtigung der \glspl{Studierender} und \glspl{Projektbetreuer}
...
Hierbei befindet sich hinter jeder funktionalen Anforderung eckigen Klammern ein
Verweis in auf den Anwendungsfall der die Funktion beschreibt und testet.
...
\begin{enumerate}[label=\swtLabel{FA}, resume]
  ...
  \item Import einer Einteilung \label{FAimport} %TODO verweis auf Test
  \item Export einer Einteilung \label{FAexport}%TODO verweis auf Test
...
\begin{enumerate}[label=\swtLabel{FA}, resume]
  ...
  \label{FAadminSPOAuswahl} %TODO verweis auf Test
  ...
  \label{FAimport2} %TODO verweis auf Test
  \item Export von \enquote{.csv}"=Dateien mit Noten der \glspl{Studierender}n
  \label{FAexport2} %TODO verweis auf Test
