...
\begin{enumerate}[label=\swtLabel{FA}, resume]
	...
	%TODO
	% gz entfernen?an TODO Was ist noch mit W30 gemeint?
...
%   
  ...
  \end{description}
   ...
   \item
  \begin{description}
  \item[Anwendung:] Übersicht über Lerngruppe
  \item[Ziel:] Studierender kann sehen wer in seiner Lerngruppe ist
  	\item[Vorbedingung:] Studierender ist angemeldet und befindet sich auf der
  	...
  	in der Lerngruppe ist in der er angemeldet ist
  	\item[Beschreibung:]~
  	\begin{enumerate}
  	  \item[1.] Der Studierende klickt auf Lerngruppe
  ...
  \item[Ziel:] Studierender kann sehen welchem Projekt er zugeteilt wurde
  	\item[Vorbedingung:] Studierender ist angemeldet und befindet sich auf der
  	Webseite in Studierendensicht. 
  	\item[Nachbedingung(Erfolg):] Studierender befindet sich in der Maske
  	Einteilungsergebnisse. %TODO verweis
  	Falls der Admin die Einteilungsergebnisse bereits veröffentlicht hat kann er
  	sehen welchem Projekt er zugeteilt wurde. Sonst sieht er, dass die Einteilung
  	noch ingange ist
  	\item[Nachbedingung(Fehlschlag):] Der Studierende ist nicht in der
  ...
  \end{description}
      ...
      \item
  \begin{description}
  \item[Anwendung:] Austritt aus einer Lerngruppe
  \item[Ziel:] Studiernder möchte aus einer Lerngruppe austreten
  	\item[Vorbedingung:] Studierender ist angemeldet und befindet sich auf der
  	Webseite in Studierndensicht. Weiterhin ist er mitglied einer Lerngruppe
  	%TODO verweis
  	
  	\item[Nachbedingung(Erfolg):] Studierender ist kein Mitglied der Lerngruppe
  	mehr
  	
  	\item[Nachbedingung(Fehlschlag):] Studierender ist immernoch Mitglied der
  	Lerngruppe
  	\item[Akteure:] Studierender
  	\item[Auslösen des Ereignisses:] Studierender möchte einer anderen Lerngruppe
  	beitreten oder eigene Projektbewertungen abgeben
  	\item[Beschreibung:]~
  	\begin{enumerate}
  	  \item[1.] Der Studierende klickt auf Lerngruppe. Nun befindet er sich in
  	  der \enquote{Lerngruppe}-Maske %TODO verweis
