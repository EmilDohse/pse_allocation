...
oder die Möglichkeit zur automatischen Benachrichtigung der betroffenen \glspl{Studierender}n und Betreuer über die
...
\begin{enumerate} [label=\swtLabel{B}]
  ...
  \begin{description}
  	...
  	\item[Ziel:] Der Betreuer kann sehen, wer zu seinen \glspl{Projekt}n zugeteilt wurde und erhält weitere Informationen
  ...
  \item \label{UCbetreuerNoteneintragung}
    \begin{description}
  	...
  	\item[Vorbedingung:] Gruppe hat \glspl{Studierender}n als Teilnehmer
...
\begin{enumerate} [label=\swtLabel{A}]
  ...
  \item[Ziel:] Finden der bestmöglichen \gls{Einteilung}
  	...
  	\item[Erweiterungen:]~
  	\begin{enumerate}
  	  \item[nach 3)] Betreuer und \glspl{Studierender} werden per E"=Mail über die \gls{Einteilung} informiert
  	 \end{enumerate}
  	\item[Alternativen:] -keine-
