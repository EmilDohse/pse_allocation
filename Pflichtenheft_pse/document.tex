...
(\ref{FAadminGüte}), welche verschieden gewichtet werden, zusammengesetzt und
...
\newglossaryentry{CMS}{name=Campus Management System, description={hallo%TODO%
% ausllenfü}}
}}
...
\begin{enumerate}[label=\swtLabel{W}]
  ...
  \item Abbrechen der Berechnung der \gls{Einteilung} möglich 
        \item Datenabgleich mit dem \gls{CMS} via \enquote{.csv}"=Datei 
...
\end{enumerate}
  ...
  %TODO falls leer bleibt entfernen
\end{itemize}
...
\begin{enumerate} [label=\swtLabel{A}]
  ...
  \end{description}
    ...
    \begin{enumerate}
      \item[1.] Der Administrator ist im Administratorbereich der Webseite
      \item[2.] Klick auf \enquote{Einstellungen} %TODO einstellungen erstezen
      % cht richtigen reiterdu 
      in der Seitenleiste
       ...
       %TODO richtig so ? GUI VERGLEICHEN
    ...
    \item[Alternativen:] 
        ...
        \begin{enumerate}
          ...
          Dateipfad in die Eingabebox neben %TODO name der Eingabebox
          \item [4a)]Falls Daten aus dem \gls{CMS} importiert werden wird %TODO
        \end{enumerate}
  ...
  \end{description}
    ...
    Studierendendaten existieren %TODO
    \item[Nachbedingung(Erfolg):] Der Administrator ist im Bereich
    ...
    \item[Alternativen:] 
        ...
        \begin{enumerate}
          ...
          wird der Dateipfad in die Eingabebox neben %TODO name der Eingabebox
