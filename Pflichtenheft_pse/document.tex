...
gemeinsam eine Bewertung abgeben für die \glspl{Projekt}einteilung. Zusätzlich
...
\begin{enumerate} [label=\swtLabel{A}]
  ...
  \end{description}
	...
	\begin{description}
		...
		\glspl{Studierender} nicht anmelden und einloggen
		\item[Nachbedingung(Fehlschlag):] Anmelden und einloggen sind vor dem
		Datum möglich
		\item[Beschreibung:]~
		\begin{enumerate}[label=\arabic*.]
  ...
  \item[Ziel:] Finden der bestmöglichen Teameinteilung
  	...
  	\begin{enumerate} 
  	  ...
  	  \item[2.] Auswahl des Reiters, der die zu veröffentliche Einteilung enthält
  	  \item[3.] Durch Klick auf \enquote{Einteilung veröffentlichen} wird diese
  	  Einteilung final ausgewählt 
  	\end{enumerate}
  	\item[Erweiterungen:]~
  	\begin{enumerate}
  	  \item[nach 3)] Betreuer und Studierende werden über ihre Teams
  ...
  \end{description}
    ...
    \begin{enumerate}
      ...
      in der Seitenleiste
       \item[3.] Der Administrator klickt auf den \enquote{Import}"=Knopf neben den Datentyp der importiert werden soll.
  ...
  \end{description}
    ...
    \begin{enumerate}
      ...
      \item[2.] Klick auf \enquote{Export/Import} in der Seitenleiste
       \item[3.] Der Administrator klickt auf den \enquote{Export}"=Knopf neben den Datentyp der importiert werden soll.
  ...
  \end{description}
    ...
    \begin{description}
    \item[Anwendung:] Import von \gls{CMS}"=Daten
