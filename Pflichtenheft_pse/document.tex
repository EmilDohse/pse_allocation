...
\newglossaryentry{gesplitteteGruppe}{name=Anzahl der gesplittelen \glspl{Lerngruppe},
 description={ Die Anzahl der gesplittelen \glspl{Lerngruppe} ist ein
...
\subsection{Musskriterien}
 \begin{enumerate}[label=\swtLabel{M}]
   ...
   \item Studierende können vor der Einteilung \glspl{Lerngruppe} erstellen, beitreten
    ...
    \item Verwaltung von \glspl{Lerngruppe} durch Studierende % Geneauer in FAs oder
    % auch schon hier?
...
\begin{enumerate}[label=\swtLabel{FA}, resume]
	%\item Studierende aus der\gls{Lerngruppe} entfernen \label{FAentfStudLerng} 
	%TODO
