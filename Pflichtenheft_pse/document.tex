...
\newglossaryentry{SCC-Account}{name=SCC-Account, plural=SCC-Accounts,
	description={Der SCC-Account stellt Zugangsmöglichkeiten zu Systemen und Diensten am SCC dar und wird allgemein als "Login" im KIT-Umfeld benutzt. Der \gls{SCC-Account} eines \glspl{Studierender}n wird umgangssprachlich häufig als \enquote{u-Account} bezeichnet, da er für \glspl{Studierender} stets mit einem \emph{u} beginnt}}
