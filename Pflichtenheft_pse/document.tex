...
description={Eine Lerngruppe ist ein Zusammenschluss von Studierenden, welche gemeinsam eine Bewertung abgeben für die \glspl{Projekt}inteilung. Zusätzlich werden sie bei der Einteilung gesondert berücksichtigt, sodass Studierende einer Lerngruppe möglichst ein Team bilden oder als Gruppe einem Team angehören.
}, plural=Lerngruppen}
...
\newglossaryentry{Teilleistung}{name=bestandene Teilleistung,
plural=bestandene Teilleistungen, description={%TODO ausfüllen
}}
...
%zuführen können.
%TODO formulierung
Das Produkt dient zur Einpflegung von \glspl{Projekt}n und zur Zuteilung von
Studierenden zu den \glspl{Projekt}n. Hierbei werden die Projekt-Präferenzen der
...
\begin{enumerate}[label=\swtLabel{FA}, resume]
 ...
 \begin{itemize}
   \item Eher 5er Teams als 6er Teams
   \item Studierende im Team sind im gleichen Semester
   \item Studierende höherer Semester werden bevorzugt
   \item Studierende, die bereits mehr Teilleistungen aus dem ersten Jahr
bestanden haben werdem bevorzugt 
 \end{itemize}
\end{enumerate}
...
\begin{enumerate}[label=\swtLabel{NF}]
  ...
  \item Die Eingabefelder für Eingabemasken passen bei einer Auflösung von 
	...
	Minuten
	\item Zuverlässigkeit: Die Webseite ist zu 99\% erreichbar %TODO ist das die
	% Zerlässigkeit?
...
\medskip
\includegraphics[width=0.7\textwidth,
height=0.4\textheight]{gui/admin\glspl{Projekt}.png}
...
\medskip
\includegraphics[width=0.7\textwidth,
height=0.4\textheight]{gui/projleiter\glspl{Projekt}.png}
