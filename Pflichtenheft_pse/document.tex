...
%   
  ...
  \item \label{UCstudAnmeldung}
    ...
    \item[Ziel:] \gls{Studierender} wird angemeldet und kann seine \gls{Bewertung} ändern
  	...
  	\item[Beschreibung:]
  	\begin{enumerate}
  	  \item[1.] \gls{Studierender} öffnet die Webseite
  ...
  Ersteller ist erstes Mitglied dieser
  	...
  	Webseite im \glspl{Studierender}nportal
  ...
  \item[Ziel:] \gls{Studierender} ist Mitglied einer \gls{Lerngruppe}
  	...
  	\begin{enumerate}
  	  ...
  	  \item[3.] Ist der \glspl{Studierender} nicht der \gls{Lerngruppe}
  	  zugewiesen worden, so werden die zuletzt gespeicherten \glspl{Bewertung}
  	  verwendet
  ...
  der zu bewertenden \glspl{Projekt} nochmals ansehen
  	...
  	\gls{Bewertung}smaske %TODO verweis
...
\begin{enumerate} [label=\swtLabel{B}, itemsep=2em]
  ...
  \item \label{UCbetreuerThemaErstellenÄndern}
	\begin{description}
  		...
  		\item[Beschreibung:]
  	\begin{enumerate}
  	  \item[1.] \gls{Projektbetreuer} befindet sich auf der Webseite mit den
  	  \glspl{Projekt}n
  ...
  \begin{description}
  	...
  	\begin{enumerate}
		...
		welchen \glspl{Team} seinem \gls{Projekt} zugeordnet wurden. Zusätzlich
		erhält er die Information, ob \glspl{Studierender} sich im CMS schon zum
		\gls{PSE} und \gls{TSE} angemeldet haben und ob noch \glspl{Teilleistung}
		offen sind
  	\end{enumerate}
  	\item[Erweiterungen:] -keine-
  ...
  \item \label{UCbetreuerLeaveProjekt}
	\begin{description}
  	...
  	\begin{enumerate} 
  	  \item[1.] \gls{Projektbetreuer} befindet sich auf der Webseite mit den
  	  \glspl{Projekt}n, die er betreut.
  ...
  \item \label{UCbetreuerNoteneintragung}
    \begin{description}
  	...
  	\item[Beschreibung:]
  	\begin{enumerate} 
  	  \item[1.] \gls{Projektbetreuer} befindet sich auf der Webseite mit der
  	  Notenübersicht
