...
\texdocmethod{public}{Result}{duplicateAllocation}{()}{Diese Methode erstellt eine Kopie einer kompletten Einteilung. Diese
 ...
 zurückgeleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
...
\texdocmethod{public}{Result}{moveStudents}{()}{Diese Methode verschiebt ein oder mehrere ausgewählte Studenten in ein
 ...
 Seite zur Einteilungs-Bearbeitung zurückgeleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{publishAllocation}{()}{Diese Methode veröffentlicht eine Einteilung. Dazu gehört, die Einteilung
 ...
 Einteilungs-Bearbeitungs-Seite zurückgeleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
...
\texdocmethod{public}{Result}{swapStudents}{()}{Diese Methode tauscht zwei Studenten, welche der Administrator vorher in
 ...
 Administrator auf die Seite zur Einteilungs-Bearbeitung zurückgeleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{undoAllocationEdit}{()}{Diese Methode macht die letzte Editierung rückgängig. Dies ist jedoch
 ...
 auf die Seite zur Einteilungs-Bearbeitung zurückgeleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
...
\end{texdocclassconstructors}
\begin{texdocclassmethods}
\texdocmethod{public}{void}{exportAllocation}{()}{Diese Methode lässt den Administrator eine Datei downloaden, welche in
 einem Textformat eine Einteilung speichert. Der Administrator wird
 daraufhin auf die Import$/$Export-Seite zurückgeleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{exportCMSData}{()}{Diese Methode lässt den Administrator eine Datei downloaden, welche eine
 ...
 auf die Import$/$Export-Seite zurückgeleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{exportProjects}{()}{Diese Methode lässt den Administrator eine Datei downloaden, welche in
 ...
 Administrator wird daraufhin auf die Import$/$Export-Seite zurückgeleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{void}{exportSPO}{()}{Diese Methode lässt den Administrator eine Datei downloaden, welche in
 einem Textformat eine SPO speichert. Der Administrator wird daraufhin auf
 die Import$/$Export-Seite zurückgeleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
...
\texdocmethod{public}{Result}{importAllocation}{()}{Diese Methode importiert eine Einteilung, sodass sie in der
 ...
 Import$/$Export-Seite zurückgeleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
...
\texdocmethod{public}{void}{importProjects}{()}{Diese Methode importiert eine Liste an Projekten, welche daraufhin zum
 aktuellen Semester hinzugefügt werden. Der Administrator wird daraufhin
 auf die Import$/$Export-Seite zurückgeleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{void}{importSPO}{()}{Diese Methode importiert eine SPO, sodass sie in der SPO-Auswahl eines
...
\texdocmethod{public}{Result}{solveConflicts}{()}{Diese Methode löst alle Konflikte auf, welche durch einen
 ...
 anschließend auf die Import$/$Export-Seite zurückgeleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\end{texdocclassmethods}
...
\texdocmethod{public}{Result}{adviserPage}{()}{Diese Methode gibt die Seite zurück, auf der der Administrator alle
 ...
 entfernen kann.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{allocationPage}{()}{Diese Methode gibt die Seite zurück, auf der der Administrator
 ...
 Berechnungsliste entfernen.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{exportImportPage}{()}{Diese Methode gibt die Seite zurück, auf der der Administrator
 ...
 importieren kann.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{projectEditPage}{()}{Diese Methode gibt die Seite zurück, auf der der Administrator Projekte
...
\texdocmethod{public}{Result}{addProject}{()}{Diese Methode fügt ein neues Projekt in das System ein und leitet den
 Administrator zurück auf die Seite zum editieren des Projektes.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{editProject}{()}{Diese Methode editiert ein bereits vorhandenes Projekt. Die zu
 ...
 auf die Seite zum Hinzufügen und Editieren von Projekten weitergeleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{removeProject}{()}{Diese Methode löscht ein Projekt und alle dazugehörenden Daten aus dem
 ...
 und hinzufügen von Projekten.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\end{texdocclassmethods}
...
\texdocmethod{public}{Result}{addAchievement}{()}{Diese Methode fügt eine neue Teilleistung zu einer bereits vorhandenen
 ...
 wird daraufhin zur Einstellungsseite zurückgeleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{addSemester}{()}{Diese Methode lässt den Administrator ein neues Semester erstellen und
 ...
 deshalb auf die Einstellungsseite für das Semester.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{addSPO}{()}{Diese Methode fügt eine neue leere SPO, mit einem vom Administrator
 ...
 Einstellungsseite zurückgeleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{editSemester}{()}{Diese Methode übernimmt die Änderungen, welche der Administrator im
 ...
 die Allgemeinen Informationen.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{removeAchievement}{()}{Diese Methode löscht eine bereits existierende Teilleistung aus einer
 ...
 geleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{removeSemester}{()}{Diese Methode lässt den Administrator ein Semester löschen, wenn mit
 ...
 daraufhin zur Einstellungsseite zurückgeleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{removeSPO}{()}{Diese Methode löscht eine bereits vorhandene SPO. Die SPO kann nur
 ...
 wird daraufhin auf die Einstellungsseite zurückgeleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\end{texdocclassmethods}
...
\texdocmethod{public}{Result}{accountPage}{()}{Diese Methode gibt die Seite zurück, auf der der Betreuer seine
 Studentendaten wie E-Mail-Adresse und Passwort ändern kann.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{addProject}{()}{Diese Methode fügt ein neues Projekt in das System ein und leitet den
 Betreuer zurück auf die Seite zum editieren des Projektes.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{editAccount}{()}{Diese Methode editiert die Daten des Betreuers, welche er auf der
 Account-Seite geändert hat.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{editProject}{()}{Diese Methode editiert ein bereits vorhandenes Projekt. Die zu
 ...
 Hinzufügen und Editieren von Projekten weitergeleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{joinProject}{()}{Diese Methode fügt einen Betreuer zu einem bereits existierenden Projekt
 ...
 weitergeleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{leaveProject}{()}{Diese Methode entfernt einen Betreuer aus einem existierenden Projekt,
 ...
 von Projekten weitergeleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{projectsPage}{()}{Diese Methode gibt die Seite zurück, auf der der Betreuer Projekte sieht,
...
\texdocmethod{public}{Result}{removeProject}{()}{Diese Methode löscht ein Projekt und alle dazugehörenden Daten aus dem
 ...
 dieses editieren.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{saveStudentsGrades}{()}{Diese Methode speichert alle von einem Betreuer in ein Formular
 ...
 jeweiligen Projektes weitergeleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\end{texdocclassmethods}
...
\texdocmethod{public}{Result}{addAdviser}{()}{Diese Methode fügt einen Betreuer mit den Daten aus dem vom Administrator
 ...
 anschließend auf die Betreuerübersicht weitergeleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{addAllocation}{()}{Diese Methode fügt eine Einteilungskonfiguration in die
 ...
 die Berechnungsübersichtsseite weitergeleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{addStudent}{()}{Diese Methode fügt einen Studenten in das System hinzu. Der Administrator
 ...
 Studenten weitergeleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
...
\texdocmethod{public}{Result}{indexPage}{()}{Diese Methode gibt die Seite zurück, welche die Startseite ist. Auf
 ...
 aktuelle Informationen einsehen.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{login}{()}{Diese Methode initiiert die Login-Prozedur und leitet den Anzumeldenden
 je nach Autorisierung auf die passende Seite weiter.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
...
\texdocmethod{public}{Result}{verificationPage}{()}{Diese Methode gibt die Seite zurück, welche einen Studenten verifiziert.
 ...
 dieses Parameters wird der Student verifiziert.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\end{texdocclassmethods}
...
\texdocmethod{public}{Result}{createLearningGroup}{()}{Diese Methode erstellt eine neue Lerngruppe im System hinzu und fügt den
 ...
 wird anschließend auf die Lerngruppen-Seite zurückgeleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
...
\texdocmethod{public}{Result}{joinLearningGroup}{()}{Diese Methode fügt den Studenten zu einer Lerngruppe hinzu, falls eine
 ...
 Anschließend wird der Student auf die Lerngruppen-Seite zurückgeleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{learningGroupPage}{()}{Diese Methode gibt die Seite zurück, auf der der Student sieht in welcher
 ...
 oder einer beitreten kann.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{leaveLearningGroup}{()}{Diese Methode entfernt den Student aus der aktuellen Lerngruppe.
 Anschließend wird der Student auf die Lerngruppen-Seite zurück geleitet.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{rate}{()}{Diese Methode fügt die Daten der Bewertungen eines Studenten in das
 ...
 Bewertungsseite, wo er nun seine eingegebene Bewertungen sehen kann.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{ratingPage}{()}{Diese Methode gibt die Seite zurück, auf der der Student seine
 Bewertungen abgeben kann.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\texdocmethod{public}{Result}{resultsPage}{()}{Diese Methode gibt die Seite zurück, auf der der Student das Ergebnis der
 ...
 Teammitglieder.}{\begin{texdocparameters}
\texdocparameter{die}{Seite, die als Antwort verschickt wird.}
\end{texdocparameters}
}
\end{texdocclassmethods}
