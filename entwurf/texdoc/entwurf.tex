...
\begin{itemize}
  ...
  da das CMS nicht genug Daten zur verfügung stellt um Kunflikte zu erkennen.
\end{itemize}
\subsection{Grobentwurf}
Da es sich um eine WebApplication handelt die Benutzerschnittstelle und ein
Backend aufweist wir der gängige Architekturstil \enquote{Model-View-Controller}
verwendet.
\subsubsection{Model}
...
\item[importExport] ist für den Im- und Export von Datensätzen aus dem und in
das \texttt{\bf data}-Package verantwortlich. \autoref{uml:imExport}
...
nachträglich weiter Kriterien eingefügt werden können.
\autoref{uml:qualityCriteria}
\item[security] ist für die Konfiguration der Loginprozedur und für die
estellung sicherer Verifikationscodes verantwortlich.
...
\end{description}
   ...
   \subsubsection{View}
   Der View beinhaltet HTML-Seiten.   %TODO daniel einfügen
\subsubsection{Controller}
%TODO daniel einfügen
